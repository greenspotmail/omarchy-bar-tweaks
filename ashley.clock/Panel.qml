...
Panel {
  ...
  KeyboardPanel {
    ...
    bar: root.bar
    open: root.opened
    // Under the clock icon (far left of the bar), not dead-center on the
    // screen — the panel's own edge clamping pins it to the left margin
    // since the icon already sits there.
    centerOnBar: false
